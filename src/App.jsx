    ...
    <div className="min-h-screen bg-[#F9F5EB] text-[#2D241E] font-sans selection:bg-[#8B1E1E] selection:text-[#F9F5EB] overflow-x-hidden">
         ...
         <div className="max-w-5xl mx-auto relative z-10">
          <FadeIn>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <Button variant="primary" onClick={() => { analytics.track('click', 'Email Form - Hero'); scrollToContact(); }}>Contact Pete</Button>
            </div>
          </FadeIn>
        </div>
      </header>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-12 md:mb-20">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="font-serif text-base md:text-lg leading-relaxed text-[#2D241E]">
                Every project is unique. I adapt this framework to suit your specific needs - keeping your artistic voice at the center of everything we create.
              </p>
            </div>
          </div>
        </FadeIn>
      ...
      <section id="contact" className="py-20 md:py-32 px-6 bg-[#F5F0E1] text-center relative overflow-hidden">
         ...
         <div className="relative z-10 max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-6xl font-serif font-black text-[#2D241E] mb-12 md:mb-16">Let's talk about<br/>your music</h2>
            <ContactForm />
         </div>
      </section>
