      ...
      <Section id="process" className="bg-[#F9F5EB]">
        ...
        <FadeIn delay={300}>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h3 className="text-xl md:text-2xl font-serif font-bold mt-12 mb-10">The best way to explore how we can bring your vision to life is with a simple, no-pressure chat to see if we're a good fit. Let's talk about your vision.</h3>
