          ...
          <div className="max-w-5xl mx-auto space-y-20">
            ...
            <div className="bg-[#F9F5EB] p-8 md:p-12 border-2 border-[#2D241E] shadow-lg">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <AudioPlayer label="The Voice Memo / Home Demo" isDemo={true} playerId="annie-demo" currentlyPlaying={currentlyPlaying} onPlay={setCurrentlyPlaying} />
                <AudioPlayer label="The Produced Record" isDemo={false} playerId="annie-final" currentlyPlaying={currentlyPlaying} onPlay={setCurrentlyPlaying} />
              </div>
            ...
            <div className="bg-[#F9F5EB] p-8 md:p-12 border-2 border-[#2D241E] shadow-lg opacity-50">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <AudioPlayer label="The Voice Memo / Home Demo" isDemo={true} playerId="artist2-demo" currentlyPlaying={currentlyPlaying} onPlay={setCurrentlyPlaying} />
                <AudioPlayer label="The Produced Record" isDemo={false} playerId="artist2-final" currentlyPlaying={currentlyPlaying} onPlay={setCurrentlyPlaying} />
              </div>
            ...
            <div className="bg-[#F9F5EB] p-8 md:p-12 border-2 border-[#2D241E] shadow-lg opacity-50">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <AudioPlayer label="The Voice Memo / Home Demo" isDemo={true} playerId="artist3-demo" currentlyPlaying={currentlyPlaying} onPlay={setCurrentlyPlaying} />
                <AudioPlayer label="The Produced Record" isDemo={false} playerId="artist3-final" currentlyPlaying={currentlyPlaying} onPlay={setCurrentlyPlaying} />
              </div>
      ...
      <footer className="bg-[#2D241E] text-[#F9F5EB] py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="border-t border-[#F9F5EB]/20 pt-8 pb-8 text-center">
            ...
            <p className="font-mono text-sm mb-6 opacity-80 max-w-2xl mx-auto">Visit my Substack for a look inside my sessions, songwriting breakthroughs, and ideas to help your creative process.</p>
