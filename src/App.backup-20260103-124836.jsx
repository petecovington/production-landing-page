...
const AudioPlayer = ({ label, isDemo = false, playerId, currentlyPlaying, onPlay }) => {
  const isPlaying = currentlyPlaying === playerId;

  const handlePlay = () => {
    if (isPlaying) {
      onPlay(null); // Stop this player
    } else {
      onPlay(playerId); // Start this player (and stop others)
    }
  };
    ...
    <div className="min-h-screen bg-[#F9F5EB] text-[#2D241E] font-sans selection:bg-[#8B1E1E] selection:text-[#F9F5EB] overflow-x-hidden">
      ...
      <header className="relative pt-40 pb-32 md:pt-48 md:pb-40 px-6 bg-[#F5F0E1]">
         ...
         <div className="max-w-5xl mx-auto relative z-10">
          <FadeIn>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-black text-[#2D241E] leading-[0.95] mb-8 tracking-tight">
              Turn Your Demos into <br/><span className="text-[#8B1E1E]">Timeless Records</span>.
            </h1>
            <p className="text-lg md:text-xl font-serif text-[#2D241E]/60 max-w-2xl mb-12 leading-relaxed ml-2">
              Collaborative production for artists who want to capture their authentic sound without compromising on quality.
            </p>
      ...
      <Section className="bg-[#F9F5EB]">
        <FadeIn>
          <div className="max-w-4xl mx-auto">
            <div className="aspect-video w-full border-2 border-[#2D241E]/20 overflow-hidden">
              <iframe
                width="100%"
                height="100%"
                src="https://www.youtube.com/embed/Svv0LkmZ44A"
      ...
      <Section className="bg-[#F5F0E1]">
        <div className="text-center mb-16">
          ...
          <p className="font-serif text-xl text-[#2D241E]/60">Hear how a rough idea transforms through the production process.</p>
        </div>
        ...
        <FadeIn>
          <div className="max-w-5xl mx-auto space-y-20">
            {selectedExamples.map((example) => (
              <div
                key={example.id}
                className={`bg-[#F9F5EB] p-8 md:p-12 border-2 border-[#2D241E] shadow-lg ${example.isPlaceholder ? 'opacity-50' : ''}`}
              >
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  <AudioPlayer label="The Demo" isDemo={true} playerId={`${example.id}-demo`} currentlyPlaying={currentlyPlaying} onPlay={setCurrentlyPlaying} />
                  <AudioPlayer label="The Produced Record" isDemo={false} playerId={`${example.id}-final`} currentlyPlaying={currentlyPlaying} onPlay={setCurrentlyPlaying} />
                </div>
                ...
                <div className="border-l-4 border-[#8B1E1E] pl-6 py-4 bg-white/50">
                  ...
                  <p className="font-mono text-sm uppercase tracking-wider text-[#2D241E]/60">— {example.attribution || example.name}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <Section className="bg-[#F9F5EB]">
        ...
        <FadeIn>
          <div className="grid md:grid-cols-2 gap-12 items-center mb-32">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-xl mb-6 text-[#8B1E1E]">Honoring the song before we hit record.</p>
        ...
        <FadeIn delay={100}>
          <div className="grid md:grid-cols-2 gap-12 items-center mb-32">
            <div>
              ...
              <p className="text-xl mb-6 text-[#8B1E1E]">Building the sonic world, whether in-person or remote.</p>
        ...
        <FadeIn delay={200}>
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-xl mb-6 text-[#8B1E1E]">Refinement and getting your music ready for the world.</p>
              <p className="font-serif text-lg leading-relaxed mb-4">
        ...
        <FadeIn delay={300}>
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-xl text-[#2D241E]/80 mb-8">
      ...
      <section id="contact" className="py-32 px-6 bg-[#F9F5EB] text-center relative overflow-hidden">
         ...
         <div className="relative z-10 max-w-3xl mx-auto">
            <h2 className="text-5xl md:text-7xl font-serif font-black text-[#2D241E] mb-6">Ready to Start<br/>Your Project?</h2>

            <p className="text-xl font-serif mb-12">I'm currently booking for <strong>March 2026</strong>.</p>
            ...
            <div className="flex flex-col items-center gap-4 mb-12">
              ...
              <Button variant="secondary" className="text-lg whitespace-nowrap">Email Me About Your Project</Button>
            </div>
      ...
      <footer className="bg-[#2D241E] text-[#F9F5EB] py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="border-t border-[#F9F5EB]/20 pt-8 pb-8 text-center">
            ...
            <button className="px-6 py-3 font-mono text-sm uppercase tracking-wider border-2 border-[#F9F5EB] text-[#F9F5EB] hover:bg-[#F9F5EB] hover:text-[#2D241E] transition-all duration-300">
              Substack
            </button>
          </div>
